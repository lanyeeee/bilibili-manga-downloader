...
export type Config = { accessToken: string; downloadDir: string; archiveFormat: ArchiveFormat; episodeConcurrency: number; imageConcurrency: number; episodeDownloadInterval: number }
